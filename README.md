...
- `github.com/score-spec/score-go/loader` - Go functions for loading the validated json or yaml structure into a workload struct. This also provides invaluable functions for handling conventional override mechanisms and resolving of placeholder references and resource dependencies.
